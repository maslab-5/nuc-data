...
def init():
    ...
    command.moveServo(Servo.RightChute, 526)
...
act.turnToPositionNearest(Movement.Spin, 1, 2)
act.moveToPosition(1, 2, 1)
...
act.turnToPositionNearest(Movement.Spin, 2, 3)
act.moveToPosition(2, 3, 1)
